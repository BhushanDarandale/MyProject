		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					<div class=" paddingBottom">
						<span class="heading-t3"></span>
						<h2 style="margin: 10px;">Upload Videos</h2>
						<div align="right">
							<button style="margin-bottom: 20px;" type="button"
								class="btn btn-default" data-toggle="modal"
								...
								<div class="modal-dialog">
									...
									<div class="modal-content">
										...
										Are you sure?
											...
											<form name="form${loop.count }" action="deleteVideo"
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					<div class=" paddingBottom">
						<span class="heading-t3"></span>
						<h2 style="margin: 10px;">Upload News</h2>
						<div align="right">
							<button style="margin-bottom: 20px;" type="button"
								class="btn btn-default" data-toggle="modal"
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form name="formAlbum" action="addNews" method="post"
							enctype="multipart/form-data" class="comment-form">
							<input type="text" name="newsname" id="newsname" style="padding: 10px"
								placeholder="Enter News Title">
								
								<textarea  type="text" name="newsdesc" id="newsdesc" style="padding: 10px"

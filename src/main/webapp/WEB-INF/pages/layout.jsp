...
<head>
     ...
     <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
      ...
      <body>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="logo">
                           <div class="navbar-header">
                            ...
                            <a class="theme-color" href="index.html">श्री.योगेश उर्फ   &nbsp; <span>बाबु पाटे</span></a> <!--== logo ==-->
                        </div>
                    </div>
                       ...
                       <nav class="main-menu">
                        <div class="navbar-collapse collapse">
                            <ul class="nav navbar-nav"> <!--== manin menu ==-->
                                <li class="active"><a class="smoth-scroll theme-color" href="#home">मुखपृष्ठ </a></li>
                                <li><a class="smoth-scroll theme-color" href="#about">व्यक्तिविशेष </a></li>
                                <li><a class="smoth-scroll theme-color" href="#services">सेवा </a></li>
                                <li><a class="smoth-scroll theme-color" href="#work">छायाप्रत  </a></li>
        ...
        <!--======= WELCOME AREA =======-->
        <div id="home" class="welcome-area" data-stellar-background-ratio="0.4" style="background-image: url(<%=request.getContextPath() %>/resources/light/assets/img/banner-01.png);">
                ...
                <div class="row">
                    <div class="col-md-5">
                       <div class="author-image" >
                            <img src="<%=request.getContextPath() %>/resources/light/assets/img/Babu-Pate.png" alt="Author Image" style="height:550px";> <!--=== author image ===-->
                        </div>
                    </div>
        ...
        <!--===== SERVICES AREA =====-->
        <div id="services" class="services-area section-padding" class="welcome-area" data-stellar-background-ratio="0.4" style="background-image: url(<%=request.getContextPath() %>/resources/light/assets/img/service-bg-01.png);">
            <div class="container">
               <div class="row">
                   <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6">
                        <div class="single-service theme-color text-center wow fadeInUp" data-wow-delay="0.2s">
                           <div class="service-img" style="background-image: url(<%=request.getContextPath() %>/resources/light/assets/img/service/economical.png) "></div>
                            <h3>आर्थिक </h3>
                            <p>जनतेचे प्रतिनिधित्त्व करीत असताना विविध समित्यांवर काम केले आहे. </p>
                        </div>
                    </div>
                   <div class="col-md-4 col-sm-6">
                        <div class="single-service theme-color text-center wow fadeInUp" data-wow-delay="0.4s">
                           <div class="service-img" style="background-image: url(<%=request.getContextPath() %>/resources/light/assets/img/service/Socail.png) "></div>
                            <h3>सामाजिक </h3>
                            <p>जनतेचे प्रतिनिधित्त्व करीत असताना विविध समित्यांवर काम केले आहे.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <div class="single-service theme-color text-center wow fadeInUp" data-wow-delay="0.6s">
                           <div class="service-img" style="background-image: url(<%=request.getContextPath() %>/resources/light/assets/img/service/educational.png) "></div>
                            <h3>शैक्षणिक </h3>
                            <p>जनतेचे प्रतिनिधित्त्व करीत असताना विविध समित्यांवर काम केले आहे.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <div class="single-service theme-color text-center wow fadeInUp" data-wow-delay="0.8s">
                           <div class="service-img" style="background-image: url(<%=request.getContextPath() %>/resources/light/assets/img/service/Industrial.png) "></div>
                            <h3>ओद्योगिक </h3>
                            <p>जनतेचे प्रतिनिधित्त्व करीत असताना विविध समित्यांवर काम केले आहे.</p>
                        </div>
                    </div>
                   <div class="col-md-4 col-sm-6">
                        <div class="single-service theme-color text-center wow fadeInUp" data-wow-delay="1.0s">
                           <div class="service-img" style="background-image: url(<%=request.getContextPath() %>/resources/light/assets/img/service/Devetional.png) "></div>
                           <h3>धार्मिक </h3>
                            <p>जनतेचे प्रतिनिधित्त्व करीत असताना विविध समित्यांवर काम केले आहे.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <div class="single-service theme-color text-center wow fadeInUp" data-wow-delay="1.2s">
                           <div class="service-img" style="background-image: url(<%=request.getContextPath() %>/resources/light/assets/img/service/political.png) "></div>
                            <h3>राजकीय </h3>
                             <p>जनतेचे प्रतिनिधित्त्व करीत असताना विविध समित्यांवर काम केले आहे.</p>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="section-title">
                           ...
                           <p>आर्थिक धोरणांसह विविध विषयांचा व्यासंग व विश्लेषण यासाठी द यांची ख्याती आहे.</p>
                       </div>
                    </div>
                </div> <!--/.row-->
                ...
                <div class="row">
                    <ul class="work-list text-center">
                        ...
                        <li class="filter theme-color" data-filter=".webdesign">शिवजन्मोत्सव </li>
                        <li class="filter theme-color" data-filter=".development">वृक्षारोपण</li>
                        <li class="filter theme-color" data-filter=".grapich">समाजकल्याण  </li>
                    </ul>
                </div> <!--/.row-->
                    ...
                    <div class="row no-gutter">
                        <div class="col-md-4 col-sm-6 mix webdesign">
                            <div class="single-work">
                                <img src="<%=request.getContextPath() %>/resources/light/assets/img/work/1.jpg" alt="" style="width:100%, Hieght:50%";>
                                <div class="item-hover">
                                    <div class="work-table">
                                        <div class="work-tablecell">
                                            <div class="hover-content">
                                                <h4>शिवजन्मोत्सव</h4>
                                                <p>अनुभवी लोकप्रतिनिधी असून राजकीय बुद्धिचातुर्य व कौशल्य यासाठी त्यांना विविध व्यासपिठांनी गौरविलेले आहे.</p>
                                                <a class="work-popup theme-color" href="<%=request.getContextPath() %>/resources/light/assets/img/work/1.jpg"><i class="fa fa-search-plus"></i></a>
                                                <a class="work-link theme-color" href="#"><i class="fa fa-link"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-4 col-sm-6 mix webdesign">
                           <div class="single-work">
                                <img src="<%=request.getContextPath() %>/resources/light/assets/img/work/2.jpg" alt="" style="width:100%, Hieght:50%";>
                                <div class="item-hover">
                                    <div class="work-table">
                                        <div class="work-tablecell">
                                            <div class="hover-content">
                                                <h4>शिवजन्मोत्सव</h4>
                                                <p>अनुभवी लोकप्रतिनिधी असून राजकीय बुद्धिचातुर्य व कौशल्य यासाठी त्यांना विविध व्यासपिठांनी गौरविलेले आहे.</p>
                                                <a class="work-popup theme-color" href="<%=request.getContextPath() %>/resources/light/assets/img/work/2.jpg"><i class="fa fa-search-plus"></i></a>
                                                <a class="work-link theme-color" href="#"><i class="fa fa-link"></i></a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-4 col-sm-6 mix development">
                            <div class="single-work">
                                <img src="<%=request.getContextPath() %>/resources/light/assets/img/work/3.jpg" alt="" style="width:100%, Hieght:50%";>
                                <div class="item-hover">
                                    <div class="work-table">
                                        <div class="work-tablecell">
                                            <div class="hover-content">
                                                <h4>वृक्षारोपण</h4>
                                                <p>वृक्षारोपणवृक्षारोपणवृक्षारोपणवृक्षारोपणवृक्षारोपणवृक्षारोपण वृक्षारोपण  वृक्षारोपण  वृक्षारोपण</p>
                                                <a class="work-popup theme-color" href="<%=request.getContextPath() %>/resources/light/assets/img/work/3.jpg"><i class="fa fa-search-plus"></i></a>
                                                <a class="work-link theme-color" href="#"><i class="fa fa-link"></i></a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-4 col-sm-6 mix development">
                           <div class="single-work">
                                <img src="<%=request.getContextPath() %>/resources/light/assets/img/work/4.jpg" alt="" style="width:100%, Hieght:50%";>
                                <div class="item-hover">
                                    <div class="work-table">
                                        <div class="work-tablecell">
                                            <div class="hover-content">
                                                <h4>वृक्षारोपण</h4>
                                                <p>वृक्षारोपण वृक्षारोपण वृक्षारोपण वृक्षारोपण वृक्षारोपण वृक्षारोपण वृक्षारोपण वृक्षारोपण वृक्षारोपण वृक्षारोपण वृक्षारोपण </p>
                                                <a class="work-popup theme-color" href="<%=request.getContextPath() %>/resources/light/assets/img/work/4.jpg"><i class="fa fa-search-plus"></i></a>
                                                <a class="work-link theme-color" href="#"><i class="fa fa-link"></i></a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-4 col-sm-6 mix grapich">
                          <div class="single-work">
                                <img src="<%=request.getContextPath() %>/resources/light/assets/img/work/5.jpg" alt="" style="width:100%, Hieght:50%";>
                                <div class="item-hover">
                                    <div class="work-table">
                                        <div class="work-tablecell">
                                            <div class="hover-content">
                                                <h4>समाजकल्याण </h4>
                                                <p>समाजकल्याण समाजकल्याण समाजकल्याण समाजकल्याण समाजकल्याण समाजकल्याण समाजकल्याण समाजकल्याण समाजकल्याण समाजकल्याण समाजकल्याण .</p>
                                                <a class="work-popup theme-color" href="<%=request.getContextPath() %>/resources/light/assets/img/work/5.jpg"><i class="fa fa-search-plus"></i></a>
                                                <a class="work-link theme-color" href="#"><i class="fa fa-link"></i></a>
                                            </div>
                                        </div>
                                    </div>
                         ...
                         <div class="col-md-4 col-sm-6 mix grapich">
                           <div class="single-work">
                                <img src="<%=request.getContextPath() %>/resources/light/assets/img/work/6.jpg" alt="" style="width:100%, Hieght:100%";>
                                <div class="item-hover">
                                    <div class="work-table">
                                        <div class="work-tablecell">
                                            <div class="hover-content">
                                                <h4>समाजकल्याण </h4>
                                                <p>समाजकल्याण समाजकल्याण समाजकल्याण समाजकल्याण  समाजकल्याण समाजकल्याण समाजकल्याण समाजकल्याण .</p>
                                                <a class="work-popup theme-color" href="<%=request.getContextPath() %>/resources/light/assets/img/work/6.jpg"><i class="fa fa-search-plus"></i></a>
                                                <a class="work-link theme-color" href="#"><i class="fa fa-link"></i></a>
                                            </div>
                                        </div>
                                    </div>
       ...
       <!--===== STAT AREA ======  
        ...
        <!-- <div id="testimonial" class="testimonial-area section-padding">
         ...
         <!--====== CONTACT INFO AREA ======-->
        <div id="contact" class="contact-info-area section-padding" class="welcome-area" data-stellar-background-ratio="0.4" style="background-image: url(<%=request.getContextPath() %>/resources/light/assets/img/Contact-bg.png);">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="section-title">
                ...
                <div class="row wow fadeInUp" data-wow-delay="0.4s" style="alingn:center";>
                   <div class="col-md-6 col-sm-12 col-xs-12">
                          <div class="contact-form">
                             <form id="contact-form" method="post" action="http://programmerhasan.com/demos/light/light/contact.php">
                             <div class="messages"></div>
                                <div class="controls">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input id="form_name" type="text" name="name" class="form-control" placeholder="नाव*" required="required" data-error="Name is required.">
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input id="form_email" type="email" name="email" class="form-control" placeholder="ई मेल*" required="required" data-error="Valid email is required.">
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                                     </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <textarea id="form_message" name="message" class="form-control" placeholder="संदेश*" rows="7" required="required" data-error="Please,leave us a message."></textarea>
                                                <div class="help-block with-errors"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <input type="submit" class="btn btn-effect btn-sent theme-color" value="संदेश  पाठवा ">
                                        </div>
                                    </div>
                                </div>
                            </form>
                     ...
                     <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="author-adress">
                            ...
                            <div class="single-address theme-color">
                                ...
                                <p>(+९१) १२३४५६७८९०  <br> (+९१) ०९८७६५४३२१ </p>
                            </div>
                            <!--<div class="single-address theme-color">
                            ...
                            <div class="social-link">
                                <ul>
                                    <li><a class="facebook-color theme-color" href="https://www.facebook.com/Babu-Pate-%E0%A4%B6%E0%A5%8D%E0%A4%B0%E0%A5%80%E0%A4%AF%E0%A5%8B%E0%A4%97%E0%A5%87%E0%A4%B6-%E0%A4%89%E0%A4%B0%E0%A5%8D%E0%A4%AB-%E0%A4%AC%E0%A4%BE%E0%A4%AC%E0%A5%81-%E0%A4%AA%E0%A4%BE%E0%A4%9F%E0%A5%87-627037160708490/"><i class="fa fa-facebook"></i></a></li>
                                    <li><a class="linkedin-color theme-color" href="#"><i class="fa fa-linkedin"></i></a></li>
                                    <li><a class="google-color theme-color" href="#"><i class="fa fa-google-plus"></i></a></li>
                                    <li><a class="youtube-color theme-color" href="#"><i class="fa fa-youtube"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
